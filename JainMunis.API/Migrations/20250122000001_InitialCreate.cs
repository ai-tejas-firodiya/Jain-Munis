        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpiritualLineage = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LocationGeography = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SaintId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Schedules_Saints_SaintId",
                        column: x => x.SaintId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Schedules_SaintId",
                table: "Schedules",
                column: "SaintId");

            // Add check constraint for valid date range
            migrationBuilder.Sql(
                @"ALTER TABLE Schedules ADD CONSTRAINT CK_Schedules_ValidDateRange CHECK ([EndDate] >= [StartDate])");
        }
